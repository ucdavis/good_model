...
Plant_short_fixed_fuelC_filtered = Plant_short_fixed_Em[~Plant_short_fixed_Em["LAT"].isna()]
# aggregation of power plants
Plants_community, all_regions_clusters = cluster_plants(Plant_short_fixed_fuelC_filtered, 2000, 2000, 10, 5, 1, 1, 1)
