...
# %%
# ====== USER INPUT ======
json_path = r'C:\Users\ht9\PycharmProjects\good_model\Examples\California.json'
# dataframe = network.solution_dataframe(solution)  # <-- ensure this is already created
dataframe = pd.read_csv('solution.csv')
# ====== STEP 1: LOAD JSON AND CREATE FUEL MAPPING ======
...
for node in cal_data["nodes"]:
    ...
    # ====== STEP 2: FILTER PRODUCTION COLUMNS ======
production_cols = [
...
# %%
# ====== STEP 3: EXTRACT REGION & ASSET ID ======
...
# ====== STEP 4: SPLIT LOAD vs GENERATION ======
...
# ====== STEP 5: MAP FUEL TYPES AND STANDARDIZE ======
fuel_category_map = {
...
# ====== STEP 6: AGGREGATE BY REGION AND FUEL ======
...
# ====== STEP 7: ADD CALIFORNIA AGGREGATE ======
